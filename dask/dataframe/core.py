...
Dask Name: {name}, {task} tasks"""
    ...
    @insert_meta_param_description(pad=12)
    def map_partitions_2(self, func, *args, **kwargs):
        return map_partitions_2(func, self, *args, **kwargs)
...
@insert_meta_param_description
#skd : map_partitions_2 is a modified implementation of map_partitions where a dask dataframe
#      passed as a keyword argument is not converted to a pandas dataframe
def map_partitions_2(
    func,
    *args,
    meta=no_default,
    enforce_metadata=True,
