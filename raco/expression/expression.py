...
class BinaryOperator(Expression):
    ...
    #awatson updated for inter and string
    def typeof(self, scheme, state_scheme):
        lt = types.LONG_TYPE
        ft = types.DOUBLE_TYPE
        type_map = {(lt, lt): lt, (lt, ft): ft, (ft, lt): ft, (ft, ft): ft, (types.STRING_TYPE,types.STRING_TYPE) : types.STRING_TYPE}
...
class DATE(NaryOperator):
    pass

class INTERVAL(NaryOperator):
    pass
