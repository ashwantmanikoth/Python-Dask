...
#opcodes = sum([oc.literals for oc in binopclasses], [])  #python3 #skdas
literals = []
for oc in binopclasses:
    if oc.literals is not None:
        literals.append(oc.literals)
#    else:
#        literals.append(None)    
opcodes = sum(literals, [])
