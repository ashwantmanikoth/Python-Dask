...
class DecomposeGroupBy(Rule):
    ...
    def fire(self, op):
        ...
        ### awatson took this out so the groupby would act like they were running locally 
        ### i.e. the query execution plan try to make for a sql machine running parralel
...
#             remote_output_pos += len(raggs)
        ...
        local_gb = self._gb_class(op.grouping_list, op.aggregate_list, op.input,
                                  local_statemods)
